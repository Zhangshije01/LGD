...
public class SendVoiceHolder extends BaseViewHolder {
    ...
    public void bindData(Object o) {
        ...
        progress_load = (ProgressBar) view_holder.findViewById(R.id.progress_load);
        iv_fail_resend = (ImageView) view_holder.findViewById(R.id.iv_fail_resend);
        tv_send_status = (TextView) view_holder.findViewById(R.id.tv_send_status);
        tv_voice_length = (TextView) view_holder.findViewById(R.id.tv_voice_length);
        iv_voice = (ImageView)view_holder.findViewById(R.id.iv_voice);
