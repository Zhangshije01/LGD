...
//	   rightImage.setVisibility(View.VISIBLE);
     ...
     * 传入父类布局中的资源文件
     */
    public void setParam(BasesActivity activity, int mScreenWitdh, View paramView1, ImageView paramView2, ImageView paramView3, View paramView4, View paramView5) {
